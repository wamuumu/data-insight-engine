...
class SpecialEvent(BaseModel):
    ...
    acc_x_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    acc_y_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    acc_z_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    ...
    gyro_x_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    gyro_y_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    gyro_z_zero_crossings: Mapped[int] = mapped_column(Integer, nullable=False)
    ...
    acc_xy_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)
    acc_xz_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)
    acc_yz_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)

    gyro_xy_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)
    gyro_xz_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)
    gyro_yz_correlation: Mapped[float] = mapped_column(_REAL, nullable=False)
